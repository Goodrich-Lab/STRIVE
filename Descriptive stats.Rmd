...
grid.text("R squared", x = 0.96, y = 0.89, gp = gpar(fontsize = 10))
grid.text("*adjusted P<0.05", x = 0.97, y = 0.51, gp = gpar(fontsize = 6, fontface = "italic"))
...
grid.text("R squared", x = 0.95, y = 0.87, gp = gpar(fontsize = 10))
grid.text("*adjusted P<0.05", x = 0.96, y = 0.50, gp = gpar(fontsize = 6, fontface = "italic"))
