...
**Covars (included sig vars found in exposure correlation (but not including bmi and bottled water) and also added sex from outcome association): source (both), age_at_enrollment (exposure), sex (outcome), smoking (exposure), sq_average_drink_per_day (exposure)**

*sig vars from exposure correlation  "source", "age_at_enrollment", "bmi", "smoking", "sq_average_drink_per_day","sq_water_bottled"
